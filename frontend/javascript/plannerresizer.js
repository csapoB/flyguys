...
function resizer(x) {
    ...
    let $swapper_div_origin_destination = $("#swapper_div_origin_destination");
    ...
    if (x.matches) { // If media query matches
        ...
        $swapper_div_origin_destination.addClass("mb-2");
    ...
    $swapper_div_origin_destination.removeClass("mb-2");
