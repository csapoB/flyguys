...
CREATE VIEW IF NOT EXISTS number_of_flights_of_users AS
	SELECT useraccount.UserID, COUNT(DISTINCT past_reservations.FlightID) AS "NumberOfFlights" FROM useraccount LEFT JOIN (SELECT not_cancelled_reservations.PassengerID, not_cancelled_reservations.FlightID FROM not_cancelled_reservations INNER JOIN flight ON not_cancelled_reservations.FlightID = flight.FlightID WHERE flight.DepartureDateTime < NOW()) AS past_reservations ON useraccount.UserID = past_reservations.PassengerID GROUP BY useraccount.UserID;
...
("admin", "admin@admin.admin", "$2b$10$nAETe84Wnqon6iMkr0LMmORd76sUgCcME/cmaN0D/t2MjEgok5kqK", 1),
...
("ZRH", "BUD", DATE_ADD(CONCAT(YEAR(NOW()), "-", MONTH(NOW()), "-15 16:30:00"), INTERVAL 1 MONTH), DATE_ADD(CONCAT(YEAR(NOW()),"-",MONTH(NOW()), "-15 18:10:00"), INTERVAL 1 MONTH), 6, 26700),
("ATH", "WAW", CONCAT(YEAR(NOW()), "-", MONTH(NOW()), "-28 15:10:00"), CONCAT(YEAR(NOW()),"-",MONTH(NOW()), "-28 16:40:00"), 1, 30000),
("MUC", "ARN", CONCAT(YEAR(NOW()), "-", MONTH(NOW()), "-28 18:40:00"), CONCAT(YEAR(NOW()),"-",MONTH(NOW()), "-28 20:55:00"), 3, 80000),
("FCO", "OSL", DATE_ADD(CONCAT(YEAR(NOW()), "-", MONTH(NOW()), "-01 11:10:00"), INTERVAL 1 MONTH), DATE_ADD(CONCAT(YEAR(NOW()),"-",MONTH(NOW()), "-01 14:20:00"), INTERVAL 1 MONTH), 4, 32000),
("MAD", "CDG", DATE_ADD(CONCAT(YEAR(NOW()), "-", MONTH(NOW()), "-02 14:30:00"), INTERVAL 1 MONTH), DATE_ADD(CONCAT(YEAR(NOW()),"-",MONTH(NOW()), "-02 16:35:00"), INTERVAL 1 MONTH), 2, 75000),
("ATH", "LIS", DATE_ADD(CONCAT(YEAR(NOW()), "-", MONTH(NOW()), "-07 17:00:00"), INTERVAL 1 MONTH), DATE_ADD(CONCAT(YEAR(NOW()),"-",MONTH(NOW()), "-07 19:10:00"), INTERVAL 1 MONTH), 9, 96000),
("MUC", "AMS", DATE_ADD(CONCAT(YEAR(NOW()), "-", MONTH(NOW()), "-08 19:40:00"), INTERVAL 1 MONTH), DATE_ADD(CONCAT(YEAR(NOW()),"-",MONTH(NOW()), "-08 21:10:00"), INTERVAL 1 MONTH), 8, 44000),
("ATH", "PRG", DATE_ADD(CONCAT(YEAR(NOW()), "-", MONTH(NOW()), "-10 14:00:00"), INTERVAL 1 MONTH), DATE_ADD(CONCAT(YEAR(NOW()),"-",MONTH(NOW()), "-10 15:40:00"), INTERVAL 1 MONTH), 5, 50000),
("MUC", "LHR", DATE_ADD(CONCAT(YEAR(NOW()), "-", MONTH(NOW()), "-13 16:15:00"), INTERVAL 1 MONTH), DATE_ADD(CONCAT(YEAR(NOW()),"-",MONTH(NOW()), "-13 17:20:00"), INTERVAL 1 MONTH), 7, 39000),
("BUD", "FRA", DATE_ADD(CONCAT(YEAR(NOW()), "-", MONTH(NOW()), "-15 23:30:00"), INTERVAL 1 MONTH), DATE_ADD(CONCAT(YEAR(NOW()),"-",MONTH(NOW()), "-16 01:10:00"), INTERVAL 1 MONTH), 6, 26500),
("WAW", "BRU", CONCAT(YEAR(NOW()), "-", MONTH(NOW()), "-28 18:25:00"), CONCAT(YEAR(NOW()),"-",MONTH(NOW()), "-28 20:25:00"), 1, 21000),
("ARN", "OSL", CONCAT(YEAR(NOW()), "-", MONTH(NOW()), "-28 22:40:00"), CONCAT(YEAR(NOW()),"-",MONTH(NOW()), "-28 23:40:00"), 3, 7500),
("OSL", "DUB", DATE_ADD(CONCAT(YEAR(NOW()), "-", MONTH(NOW()), "-01 16:20:00"), INTERVAL 1 MONTH), DATE_ADD(CONCAT(YEAR(NOW()),"-",MONTH(NOW()), "-01 17:35:00"), INTERVAL 1 MONTH), 4, 66000),
("CDG", "LHR", DATE_ADD(CONCAT(YEAR(NOW()), "-", MONTH(NOW()), "-02 17:05:00"), INTERVAL 1 MONTH), DATE_ADD(CONCAT(YEAR(NOW()),"-",MONTH(NOW()), "-02 17:05:00"), INTERVAL 1 MONTH), 2, 7700),
("LIS", "DUB", DATE_ADD(CONCAT(YEAR(NOW()), "-", MONTH(NOW()), "-07 22:00:00"), INTERVAL 1 MONTH), DATE_ADD(CONCAT(YEAR(NOW()),"-",MONTH(NOW()), "-08 00:45:00"), INTERVAL 1 MONTH), 9, 106000),
("AMS", "IST", DATE_ADD(CONCAT(YEAR(NOW()), "-", MONTH(NOW()), "-08 22:25:00"), INTERVAL 1 MONTH), DATE_ADD(CONCAT(YEAR(NOW()),"-",MONTH(NOW()), "-09 03:50:00"), INTERVAL 1 MONTH), 8, 140000),
("PRG", "BRU", DATE_ADD(CONCAT(YEAR(NOW()), "-", MONTH(NOW()), "-10 17:05:00"), INTERVAL 1 MONTH), DATE_ADD(CONCAT(YEAR(NOW()),"-",MONTH(NOW()), "-10 18:35:00"), INTERVAL 1 MONTH), 5, 25000),
("LHR", "FCO", DATE_ADD(CONCAT(YEAR(NOW()), "-", MONTH(NOW()), "-13 19:10:00"), INTERVAL 1 MONTH), DATE_ADD(CONCAT(YEAR(NOW()),"-",MONTH(NOW()), "-13 22:50:00"), INTERVAL 1 MONTH), 7, 80000),
("FRA", "BCN", DATE_ADD(CONCAT(YEAR(NOW()), "-", MONTH(NOW()), "-16 03:00:00"), INTERVAL 1 MONTH), DATE_ADD(CONCAT(YEAR(NOW()),"-",MONTH(NOW()), "-16 05:10:00"), INTERVAL 1 MONTH), 6, 49500),
("BRU", "WAW", CONCAT(YEAR(NOW()), "-", MONTH(NOW()), "-28 21:50:00"), CONCAT(YEAR(NOW()),"-",MONTH(NOW()), "-28 23:50:00"), 1, 29000),
("OSL", "VIE", DATE_ADD(CONCAT(YEAR(NOW()), "-", MONTH(NOW()), "-01 00:35:00"), INTERVAL 1 MONTH), DATE_ADD(CONCAT(YEAR(NOW()),"-",MONTH(NOW()), "-01 02:55:00"), INTERVAL 1 MONTH), 3, 46000),
("DUB", "CPH", DATE_ADD(CONCAT(YEAR(NOW()), "-", MONTH(NOW()), "-01 20:00:00"), INTERVAL 1 MONTH), DATE_ADD(CONCAT(YEAR(NOW()),"-",MONTH(NOW()), "-01 23:10:00"), INTERVAL 1 MONTH), 4, 33000),
("LHR", "FRA", DATE_ADD(CONCAT(YEAR(NOW()), "-", MONTH(NOW()), "-02 19:05:00"), INTERVAL 1 MONTH), DATE_ADD(CONCAT(YEAR(NOW()),"-",MONTH(NOW()), "-02 21:50:00"), INTERVAL 1 MONTH), 2, 19800),
("DUB", "FCO", DATE_ADD(CONCAT(YEAR(NOW()), "-", MONTH(NOW()), "-08 02:00:00"), INTERVAL 1 MONTH), DATE_ADD(CONCAT(YEAR(NOW()),"-",MONTH(NOW()), "-08 05:10:00"), INTERVAL 1 MONTH), 9, 90000),
("IST", "BUD", DATE_ADD(CONCAT(YEAR(NOW()), "-", MONTH(NOW()), "-09 05:00:00"), INTERVAL 1 MONTH), DATE_ADD(CONCAT(YEAR(NOW()),"-",MONTH(NOW()), "-09 05:00:00"), INTERVAL 1 MONTH), 8, 80000),
("BRU", "ARN", DATE_ADD(CONCAT(YEAR(NOW()), "-", MONTH(NOW()), "-10 20:05:00"), INTERVAL 1 MONTH), DATE_ADD(CONCAT(YEAR(NOW()),"-",MONTH(NOW()), "-10 22:20:00"), INTERVAL 1 MONTH), 5, 51000),
