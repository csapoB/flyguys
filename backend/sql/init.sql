...
CREATE VIEW IF NOT EXISTS available_flights_hun AS
	SELECT flights_with_flight_time_hun.* FROM flights_with_flight_time_hun WHERE flights_with_flight_time.DepartureDateTime > NOW();

CREATE VIEW IF NOT EXISTS available_flights_en AS
	SELECT flights_with_flight_time_en.* FROM flights_with_flight_time_en WHERE flights_with_flight_time.DepartureDateTime > NOW();
